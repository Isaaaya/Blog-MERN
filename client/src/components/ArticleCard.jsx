...
const ArticleCard = ({ title, description, author, imageUrl }) => {
  return (
    <div className="flex flex-col w-[290px] 2xl:w-[275px] rounded-xl shadow-lg text-textMain max-md:w-[330px] overflow-hidden">
      <LazyLoadImage
